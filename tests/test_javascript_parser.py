...
def test_parser_initialization(javascript_parser):
    ...
    assert javascript_parser.is_available or not javascript_parser.is_available  # May not be available in test env
...
def test_no_typescript_patterns():
    ...
    parser_file = Path(__file__).parent.parent / "providers" / "parsing" / "javascript_parser.py"
