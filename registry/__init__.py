...
from providers.parsing.json_parser import JsonParser
from providers.parsing.yaml_parser import YamlParser
from providers.parsing.text_parser import TextParser
...
class ProviderRegistry:
    ...
    def _register_default_providers(self) -> None:
        ...
        try:
            self.register_language_parser(Language.TEXT, TextParser)
            if not os.environ.get("CHUNKHOUND_MCP_MODE"):
                logger.debug("Registered TEXT parser")
        except Exception as e:
